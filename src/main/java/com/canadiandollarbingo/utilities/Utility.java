...
public class Utility extends ManageBrowser {
     ...
     */
    public int getSizeOfElement(List<WebElement> elements) {
...
//************************** ScreenShot Methods *********************************************//
    ...
    public static void takeScreenShot() {
        String filePath = System.getProperty("user.dir") + "/src/main/java/com/com/canadiandollarbingo/screenshorts/";
    ...
    public static String getScreenshot(WebDriver driver, String screenshotName) {
        ...
        String destination = System.getProperty("user.dir") + "/src/main/java/com/com/canadiandollarbingo/screenshorts/" + screenshotName + dateName + ".png";
